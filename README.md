...
> Открыть эту страницу в [https://morzal1s.github.io/-microbit-test/](https://morzal1s.github.io/-microbit-test/)
...
* найдите **https://github.com/morzal1s/-microbit-test** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/morzal1s/-microbit-test/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/morzal1s/-microbit-test** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/morzal1s/-microbit-test/raw/master/.github/makecode/blocks.png)
